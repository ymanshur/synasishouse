...
type Repo interface {
	...
	CheckStock(ctx context.Context, code string, amount int32) error
	ReserveStock(ctx context.Context, code string, amount int32) error
	ReleaseStock(ctx context.Context, code string, amount int32) error
}
